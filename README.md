...
| 监测层 | 典型对象 | 信号形态 | Lead Time | 确定性 | 投研用法 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Science Lab / 前沿** | 顶刊、实验室、开源与榜单 | Paper、模型卡、评测、技术博客 | 最长 | 最低（叙事多、KPI 少） | 雷达与主题预置，少直接定价 |
| **创业 / 未上市** | Frontier lab、neocloud、供应链中游 | 融资、合同、排产、出货、政策文本 | 中长 | 中（事件真、口径杂） | 领先指标与路径候选的主要来源 |
| **上市公司** | 持仓与可比公司 | 财报、股东信、电话会、8-K / 巨潮 | 最短 | 最高（可对账 KPI） | 锚定验证与披露回写；降维终点 |
