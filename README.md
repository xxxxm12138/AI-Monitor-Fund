...
漏斗是**成熟度轴**（信息形态从叙事到可对账 KPI）；**D1–D7 是主题轴**（监测 AI 发展拆成哪几类对象），两轴交叉而非互相替代。同一维可以同时出现在多层，只是主落点不同：
...
七维全称（投入 / 能力 / 变现 / 约束）：**D1** 算力供给 · **D2** 数据供给 · **D3** 资本 · **D4** 人才 · **D5** 能力与算法前沿 · **D6** 商用落地 / token 经济 · **D7** 政策 · 能源 · 安全。基金视角优先级约为 D1 > D7 > D3 > D5 > D6 > D2 > D4。

*   **核心优势 (Extra Value)**：结合上述两点，体系里存在可兑现的差异化优势——利用中国供应链地面数据（如光模块排产）的时间差与前瞻性，对美股 KPI 做 Nowcast，并据此拆解所需资源与路径。
